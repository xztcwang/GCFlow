...
from flow_ssl.nde import transforms
from flow_ssl.nde.transforms import splines
...
class CouplingTransform(transforms.Transform):
    ...
    def forward(self, x, context=None):
        ...
        identity_split = x[:, self.identity_features, ...]
        transform_split = x[:, self.transform_features, ...]
